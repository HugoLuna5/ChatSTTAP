...
public class UIUtils {
    ...
    public static final String BUTTON_TEXT_FORGOT_PASS = "¿Olvidaste tu contraseña?";
    public static final String BUTTON_TEXT_REGISTER = "Registrarte";

    public static final String PLACEHOLDER_TEXT_USERNAME = "Numero de control/Usuario";
